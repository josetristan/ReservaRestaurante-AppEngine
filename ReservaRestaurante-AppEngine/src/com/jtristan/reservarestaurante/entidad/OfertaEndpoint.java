...
@Api(name = "ofertaendpoint", namespace = @ApiNamespace(ownerDomain = "jtristan.com", ownerName = "jtristan.com", packagePath = "reservarestaurante.entidad"))
public class OfertaEndpoint {
	...
	public Oferta getOferta(@Named("id") String id) {
	...
	public void removeOferta(@Named("id") String id) {
		PersistenceManager mgr = getPersistenceManager();
		try {
	...
	private boolean containsOferta(Oferta oferta) {
		...
		try {
			mgr.getObjectById(Oferta.class, oferta.getClave());
